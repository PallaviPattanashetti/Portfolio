        ...
        <header className="mb-20">
          ...
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <p className="max-w-2xl border-l-4 border-blue-600 pl-6 text-lg text-slate-600 italic">
              My background in teaching gave me a unique lens for logic: I
              do not just write code; I architect systems that are clear,
 ...
 <div className="mb-24 grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="space-y-4 text-slate-700">
              <p>
                Currently immersed in an intensive fellowship at{" "}
                <strong>Code Stack Academy</strong>, focusing on rapid,
                project-based development.
              </p>
              <p>
                My transition into tech is defined by a deep dive into
                Object-Oriented Programming and a commitment to mastering the
          ...
          <div className="rounded-3xl bg-blue-600 p-8 text-white shadow-sm">
            ...
            <p className="opacity-90">
              Building robust back-end systems with C# and .NET while creating
              front-end interfaces that are intuitive and powerful.
            </p>
          </div>
        </div>
        ...
        <div className="mb-24">
          <h2 className="mb-10 text-center text-3xl font-black">Technical Stack</h2>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <h3 className="mb-2 font-bold text-blue-600">Languages</h3>
              <p className="text-sm text-slate-600">C#, TypeScript, JavaScript, HTML, CSS</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <h3 className="mb-2 font-bold text-blue-600">Front-End</h3>
              <p className="text-sm text-slate-600">Next.js, React, Tailwind CSS, SASS</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <h3 className="mb-2 font-bold text-blue-600">Back-End</h3>
              <p className="text-sm text-slate-600">ASP.NET Core, Web API, Node.js</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <h3 className="mb-2 font-bold text-blue-600">Design & Tools</h3>
              <p className="text-sm text-slate-600">Figma, Git, GitHub, Postman</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              ...
              >
                <div className="flex flex-col justify-between gap-4 md:flex-row">
                  ...
                  <div className="md:text-right">
                    ...
                    <p className="font-medium text-slate-800">{project.focus}</p>
                  </div>
                </div>
              </a>
            ))}
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg font-semibold">Pallavi.Pattanashetti@gmail.com</p>
              </div>
            </a>
            ...
            <a
              ...
              className="flex items-center gap-6 rounded-3xl border border-slate-200 bg-white p-8 transition-shadow hover:shadow-md"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 font-bold text-white text-xl">in</div>
              <div>
            ...
            >
              ...
              <div>
                <p className="text-xs font-bold tracking-widest text-slate-400 uppercase">GitHub</p>
                <p className="text-lg font-semibold text-slate-900">View Projects</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="rounded-3xl bg-slate-900 p-10 text-white">
          <div className="flex flex-col justify-between gap-10 md:flex-row">
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <p className="font-bold text-blue-400">Software Engineering Fellowship</p>
                  <p className="text-sm text-slate-400">Code Stack Academy</p>
                </div>
                <div>
                  <p className="font-bold text-blue-400">Master of Arts in English Literature</p>
                  <p className="text-sm text-slate-400">Professional background in structured analysis.</p>
                </div>
              </div>
            </div>
            <div className="flex h-fit flex-wrap gap-2">
              {skills.map((skill) => (
                <span key={skill} className="rounded-lg bg-white/10 px-3 py-1 text-xs">{skill}</span>
              ))}
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
              <div className="text-center md:text-left">
                ...
                <p className="text-sm text-slate-500 font-medium">Software Engineer | educator at heart.</p>
              </div>
